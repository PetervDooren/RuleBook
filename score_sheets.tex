...
\input{./styles/packages_scoresheets.tex}
...
\input{./styles/macros.tex}                        % defined in macros.tex
\input{./styles/abbrevix.tex}                      % for list of abbreviations
...
\rctitle{Forms \& Score Sheets}

\pagestyle{plain}

\input{pages/registration_form.tex}
